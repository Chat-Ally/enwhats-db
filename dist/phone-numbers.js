    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, supabase.from("phones").select("*").eq("number", customerPhone).single()];
                case 1:
                    ...
                    return [4 /*yield*/, supabase.from("phones").upsert([{ number: customerPhone }])];
                case 2:
                    upsertData = (_b.sent()).data;
                    if (upsertData)
                        return [2 /*return*/, upsertData[0]];
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _b.sent();
                    console.error('getOrCreatePhoneNumber', error_1);
