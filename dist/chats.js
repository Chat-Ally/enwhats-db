 ...
 */
export function saveChatToDB(supabase, businessId, customerPhone, chatId) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getOrCreatePhoneNumber(supabase, customerPhone)];
                case 1:
                    phoneNumber = _a.sent();
...
export function getChatByClientAndBusinessPhone(supabase, customerPhone, businessPhone) {
    return __awaiter(this, void 0, void 0, function () {
        var customerPhoneId, businesId, _a, chats, chatsError;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getPhoneIdByNumber(supabase, customerPhone)];
                case 1:
                    customerPhoneId = _b.sent();
                    return [4 /*yield*/, getBusinessIdByPhoneNumber(supabase, businessPhone)];
                case 2:
                    businesId = _b.sent();
                    return [4 /*yield*/, supabase
                            .from("chats")
...
export function getChatId(supabase, businessId, customerPhoneId) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
export function getChats(supabase) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
